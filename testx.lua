...
local function createOptionHolder(holderTitle, parent, parentTable, subHolder)
	...
	if subHolder then
		close = library:Create("ImageLabel", {
			...
			ImageColor3 = parentTable.open and Color3.fromRGB(50,50,50) or Color3.fromRGB(255,100,100),
		...
		close = library:Create("ImageLabel", {
			...
			ImageColor3 = parentTable.open and Color3.fromRGB(255, 100, 100) or Color3.fromRGB(50,50,50),
			ScaleType = Enum.ScaleType.Fit,
			Parent = closeHolder
		})
	end
	...
	closeHolder.InputBegan:connect(function(input)
		if input.UserInputType == Enum.UserInputType.MouseButton1 then
			...
			if subHolder then
				tweenService:Create(close, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Rotation = parentTable.open and 45 or 180, ImageColor3 = parentTable.open and  Color3.fromRGB(50,50,50) or Color3.fromRGB(255, 100, 100)}):Play()
			else 
				tweenService:Create(close, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Rotation = parentTable.open and 45 or 180, ImageColor3 = parentTable.open and Color3.fromRGB(255, 100, 100) or Color3.fromRGB(50,50,50)}):Play()
...
function createToggle(option, parent)
	...
	local tickboxOutline = library:Create("ImageLabel", {
		...
		BackgroundTransparency = 1,
		Image = "rbxassetid://3570695787",
		ImageColor3 = option.state and Color3.fromRGB(255, 100, 100) or Color3.fromRGB(100, 100, 100),
		ScaleType = Enum.ScaleType.Slice,
		SliceCenter = Rect.new(100, 100, 100, 100),
		SliceScale = 0.02,
		Parent = main
	...
	local tickboxInner = library:Create("ImageLabel", {
		...
		BackgroundTransparency = 1,
		Image = "rbxassetid://3570695787",
		ImageColor3 = option.state and Color3.fromRGB(255, 100, 100) or Color3.fromRGB(20, 20, 20),
		ScaleType = Enum.ScaleType.Slice,
		SliceCenter = Rect.new(100, 100, 100, 100),
		SliceScale = 0.02,
	...
	function option:SetState(state)
		...
		tweenService:Create(tickboxInner, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = state and Color3.fromRGB(255, 100, 100) or Color3.fromRGB(20, 20, 20)}):Play()
		if state then
			tweenService:Create(tickboxOutline, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(255, 100, 100)}):Play()
		else
			if inContact then
...
function createButton(option, parent)
	...
	main.InputBegan:connect(function(input)
		...
		if input.UserInputType == Enum.UserInputType.MouseMovement then
			inContact = true
			tweenService:Create(round, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(255, 100, 100)}):Play()
		end
	end)
...
local function createSlider(option, parent)
	...
	main.InputBegan:connect(function(input)
		if input.UserInputType == Enum.UserInputType.MouseButton1 then
			tweenService:Create(fill, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(255, 100, 100)}):Play()
			tweenService:Create(circle, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Size = UDim2.new(3.5, 0, 3.5, 0), ImageColor3 = Color3.fromRGB(255, 100, 100)}):Play()
			sliding = true
		...
		if input.UserInputType == Enum.UserInputType.MouseMovement then
			...
			if not sliding then
				tweenService:Create(fill, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(255, 100, 100)}):Play()
				tweenService:Create(circle, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Size = UDim2.new(2.8, 0, 2.8, 0), ImageColor3 = Color3.fromRGB(255, 100, 100)}):Play()
			end
		end
	end)
	...
	main.InputEnded:connect(function(input)
		if input.UserInputType == Enum.UserInputType.MouseButton1 then
			...
			if inContact then
				...
				tweenService:Create(fill, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(255, 100, 100)}):Play()
				tweenService:Create(circle, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Size = UDim2.new(0, 0, 0, 0), ImageColor3 = Color3.fromRGB(255, 100, 100)}):Play()
			end
		end
		if input.UserInputType == Enum.UserInputType.MouseMovement then
			inContact = false
