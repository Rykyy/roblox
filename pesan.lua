...
local GoodColor = Instance.new("UIGradient")
...
GoodColor.Name = "GoodColor"
GoodColor.Parent = Container
GoodColor.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255,100,100)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 255, 255))}
...
function msg(title, text, closeTime, volume)
...
function lib.msg(title, description, closeTime, volume)
	msg(title, description, closeTime, volume)
end
